...
**Reviewed checkpoint:** P2 Token Foundation, P3 CSS Property Profile, and N12–N14 contracts
...
on exist. With N14 complete, the correct next boundary is N15, the Appearance IR
...
| ---: | --- | --- | --- |
| 1 | N15 | Appearance IR schema | slot/stage/condition structure and shorthand trace contracts |
| 2 | N16 | Motion IR schema | lifecycle, reduced-motion, Token binding, and backend-neutral value contracts |
| 3 | N17 | Behavioral Criteria Source/Profile schemas | pinned evidence manifest and Button/Select/Dialog criteria shapes |
| 4 | N18 | Generated/reference TypeScript types | schema-aligned State, Condition, declaration, Appearance, Motion, and Behavior types |
| 5 | N19 | Recipe Kernel proof | JSON-safe structural result and Button/Select/Dialog conformance suite |
...
The N12–N14 implementation sequence remained contract-first and bounded:
...
6. require declaration provenance and preserve repeated-property order in
   explicit arrays;
7. stop before Recipe or runtime implementation.
