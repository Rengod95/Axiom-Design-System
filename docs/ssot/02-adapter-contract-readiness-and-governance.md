...
**Status:** NORMATIVE \
**Depends on:** SSOT-00 v0.3.1, SSOT-01 v0.4.1, SSOT-03 v0.4.0, SSOT-04 v0.4.0, SSOT-05 v0.3.0 \
...
The repository has completed N0–N25. N26 is the next implementation boundary;
...
N25  [complete] Select conformance fixture
