...
| [SSOT-02 — Compiler Contracts, Readiness & Governance](ssot/02-adapter-contract-readiness-and-governance.md) | 0.4.2 | compiler contracts, artifacts, diagnostics, Gates A/B/C, implementation order |
