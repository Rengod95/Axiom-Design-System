...
| [SSOT-02 — Compiler Contracts, Readiness & Governance](ssot/02-adapter-contract-readiness-and-governance.md) | 0.4.3 | compiler contracts, artifacts, diagnostics, Gates A/B/C, implementation order |
| [SSOT-03 — CSS Appearance Profile & Property Policy](ssot/03-css-appearance-profile-and-property-policy.md) | 0.2.2 | generated CSS registry, direct/template/projector policy, Recipe Kernel/Appearance IR |
