...
Current lifecycle authority remains [ADR-0006](adr/0006-product-reset-and-reference-lifecycle.md), [ADR-0007](adr/0007-git-reference-and-documentation-phase.md) and the explicit implementation amendments in ADR-0009, ADR-0010 [ADR-0011](adr/0011-structural-domain-inspection-and-local-references.md) and [ADR-0012](adr/0012-typed-values-and-project-bundles.md). Documentation QA and reference restoration checks do not prove product runtime support.
