...
Retained evidence: pinned Web CSS grammar, registry, binding and validation.

Required redesign boundary: Treat as a Web profile candidate, not a shared Mobile property vocabulary.

Related decisions: D19, D24, D30.
