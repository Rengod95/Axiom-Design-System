...
export type FoundationAuthoringEdit =
  ...
  | { kind: "theme-set-create"; name: string; contexts: Record<string, string>; description?: string }
  | { kind: "theme-set-update"; id: string; name?: string; description?: string | null; contexts?: Record<string, string> }
