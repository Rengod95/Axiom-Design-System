...
export const STUDIO_PROFILE = "foundation-studio" as const;
export const STUDIO_FORMAT = "ads-studio" as const;
export const VALIDATION_PROFILES = Object.freeze([STRUCTURAL_PROFILE, DOMAIN_PROFILE, STUDIO_PROFILE]);
