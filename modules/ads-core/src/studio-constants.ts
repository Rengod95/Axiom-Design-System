...
export const STUDIO_VISUAL_PROPERTIES = Object.freeze(["background", "color", "borderColor", "borderWidth", "borderRadius", "fontSize", "opacity", "fontFamily", "fontWeight", "lineHeight", "letterSpacing", "boxShadow", "backgroundImage", "borderStyle", "border", "typography", "transitionDuration", "transitionTimingFunction", "transition"] as const);
