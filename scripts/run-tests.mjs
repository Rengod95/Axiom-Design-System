...
const TEST_ROOTS = ["modules/ads-core/test", "modules/local-store/test", "apps/cli/test", "modules/browser-store/test", "modules/target-packs/test", "apps/studio/test", "apps/delivery/test"];
