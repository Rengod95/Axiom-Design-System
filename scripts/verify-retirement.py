...
STUDIO_ASSETS = {'apps/studio/.impeccable/surfaces/workbench.md', 'apps/studio/.impeccable/design.json', 'apps/studio/DESIGN.md', 'apps/studio/index.html', 'apps/studio/src/styles.css', 'apps/studio/src/ui-system.css', 'apps/studio/src/foundation-workspace.css', 'apps/studio/.impeccable/config.json', 'apps/studio/PRODUCT.md'}
...
REVISED_PATHS = {
    ".github/workflows/quality.yml", "AGENTS.md", "README.md", "docs/README.md",
...
def implementation_profile(root: Path) -> dict | None:
    ...
    require(profile.get("extensionAdrs") == ["docs/adr/0010-source-preserving-draft-authoring.md", "docs/adr/0011-structural-domain-inspection-and-local-references.md", "docs/adr/0012-typed-values-and-project-bundles.md", "docs/adr/0013-browser-transactional-storage.md", "docs/adr/0014-studio-authoring-and-target-delivery.md", "docs/adr/0015-studio-workbench-and-catalog-authoring.md", "docs/adr/0016-foundation-onboarding-and-editor-completion.md"]
