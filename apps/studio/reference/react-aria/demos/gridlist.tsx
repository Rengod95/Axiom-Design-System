// Adapter for the first official GridList demo. Original MDX and component files remain verbatim in vendor/.
const INITIAL_PROPS = {'aria-label': 'Photos', selectionMode: 'multiple', layout: 'grid'};
  "use client";
  import {GridList, GridListItem, Text} from '../vendor/starters/docs/src/GridList';

  export default function ReferenceDemo(){return (<GridList {...INITIAL_PROPS}>
