...
/** Mounts a pinned official demo in an independent reference iframe document. */
export function mountReferenceTemplate(element: HTMLElement, sourceRow: number, options: { theme: "light" | "dark" }): () => void {
  ...
  if (!template) throw new Error(`Unknown React Aria reference source row ${sourceRow}.`);
  ...
  element.dataset.referenceProvider = "react-aria";
