...
Name: Axiom Studio. The owner's latest 2026-09-14 direction pins Geist as the primary locally hosted face, with SUIT only as a Korean glyph fallback; dark is the first-run theme and light remains supported. Fluorescent green is the sole brand accent. Studio neutral shades must be achromatic. The supplied builder video and inspector references govern short aligned property rows, restrained separators, compact icon controls and contextual disclosure. The latest request explicitly supersedes the earlier generous spacing: navigation steps down to 36px, shared controls use 28/32/36px, and internal spacing follows 4/8/12/16px. Filled selection must not also carry a competing outline. Panels and headers share translucent glass, backdrop blur and restrained edge light; glow is reserved for accent actions. Existing project tokens and saved appearance preferences remain unchanged.
